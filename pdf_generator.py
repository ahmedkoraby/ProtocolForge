...
def generate_protocol_pdf(compound_name, stock_mM, top_dose_uM, dilution_factor=3, num_points=8):
    ...
    story.append(Paragraph(f"<b>Stock:</b> {stock_mM} mM", styles['Normal']))
    ...
    story.append(table)
    story.append(Spacer(1, 0.3*inch))
    story.append(Paragraph("<i>Generated by ProtocolForge</i>", styles['Normal']))
...
def generate_batch_protocol_pdf(compounds_list):
    ...
    story.append(Spacer(1, 0.3*inch))
    story.append(Paragraph("<i>Each compound requires individual preparation</i>", styles['Normal']))
